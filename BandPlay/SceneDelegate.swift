...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        window.overrideUserInterfaceStyle = .dark /// - Note this is done because Icons shared don't work with light theme, else other UI component are built to be both light & dark mode compliant
        self.window = window
    }
